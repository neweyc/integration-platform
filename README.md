...
Currently 427 tests cover control plane features, SDK behavior, runtime agent behavior, CLI behavior (including saved-credential storage), API contracts, RBAC/security boundaries, audit logging, failure alerting, environment management, commercial API surfaces, and database-backed integration paths.
